...
function Sidebar() {
  ...
  const adminRoutes = [
    ...
    { path: '/volunteerlogviewer', name: 'Volunteer Tracking', icon: FileText },
    { path: '/sendnotification', name: 'Send Notification', icon: Send },
  ];

  const volunteerRoutes = [
    { path: '/profile', name: 'Edit', icon: User },
    { path: '/volunteer', name: 'Profile', icon: UserCheck },
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={
        `fixed top-16 left-0 h-full w-64 bg-gradient-to-br from-indigo-900 via-purple-800 to-blue-900 
